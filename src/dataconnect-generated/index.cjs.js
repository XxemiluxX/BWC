...
const listActivityLogsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListActivityLogs', inputVars);
}
listActivityLogsRef.operationName = 'ListActivityLogs';
exports.listActivityLogsRef = listActivityLogsRef;

exports.listActivityLogs = function listActivityLogs(dcOrVars, varsOrOptions, options) {
